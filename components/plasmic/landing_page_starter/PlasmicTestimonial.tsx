...
import * as sty from "./PlasmicTestimonial.module.css"; // plasmic-import: 3sngrvynYuJ0/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__vxpXf)}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__iMdmo)}
      >
        <p.PlasmicImg
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__utDhk)}
        >
          <div className={classNames(projectcss.all, sty.freeBox__sKn1G)}>
            {p.renderPlasmicSlot({
