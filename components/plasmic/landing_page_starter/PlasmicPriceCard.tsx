...
import * as sty from "./PlasmicPriceCard.module.css"; // plasmic-import: rNZinyM_comT/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__uJ7O)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__vDdsx)}>
          <div className={classNames(projectcss.all, sty.freeBox__tdODh)}>
            {p.renderPlasmicSlot({
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__ce00K)}
        >
          <div className={classNames(projectcss.all, sty.freeBox__m27JW)}>
            <div
            ...
            <div className={classNames(projectcss.all, sty.freeBox__mQy8D)}>
              {p.renderPlasmicSlot({
                defaultContents: "8",
                value: args.dollars,
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___1COyb)}
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__njfxH)}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <React.Fragment>
                <ValueProp
                  className={classNames("__wab_instance", sty.valueProp__hmJLb)}
                  description={
                    "Vestibulum mollis odio dictum ultrices facilisis molestie vestibulum"
                  }
                  icon={
                    <CheckIcon
                      className={classNames(projectcss.all, sty.svg__ejjuS)}
                      role={"img"}
                    />
                  }
                />
                ...
                <ValueProp
                  className={classNames("__wab_instance", sty.valueProp__joWb0)}
                  description={"Mus consequat a justo"}
                  icon={
                    <CheckIcon
                      className={classNames(projectcss.all, sty.svg___8RyNk)}
                      role={"img"}
                    />
                  }
                />
